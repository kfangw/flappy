...
import KfangwFlappyKfangwFlappyFlappy from './kfangw/flappy/kfangw.flappy.flappy'
...
export default { 
  ...
  KfangwFlappyKfangwFlappyFlappy: load(KfangwFlappyKfangwFlappyFlappy, 'kfangw.flappy.flappy'),
